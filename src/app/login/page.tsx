...
export default function LoginPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Solana transactions are final and near-instant — failures are extremely rare (unlike bank wires which fail regularly). If a transfer does fail, Payzap retries automatically and notifies you immediately.",
    },
    {
      q: "How does Payzap make money?",
      ...
      <nav className="fixed top-0 inset-x-0 z-50 glass">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <PayzapLogo size={36} />
            <PayzapWordmark className="text-lg" />
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm text-[var(--text-secondary)]">
            <a href="#problem" className="hover:text-white transition-colors">Why Payzap</a>
            ...
            <div className="grid md:grid-cols-4 gap-8 relative">
              {[
                ...
                },
                {
                  ...
                  d: "Payzap instantly converts your payment to USDC — a stablecoin always worth exactly $1. No exchange rate risk. No hidden conversion fees.",
                },
                {
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-5 items-stretch">
            ...
            <div className="rounded-2xl p-6 border-2 relative" style={{ background: 'rgba(0,230,160,0.05)', borderColor: 'var(--green)' }}>
              ...
              <div className="text-lg font-heading font-bold mb-5 text-[var(--green)]">Payzap ⚡</div>
              <ul className="space-y-3">
                {[
                  "Under 2 seconds",
                  "~$0.001 flat fee",
      ...
      <footer className="border-t border-[rgba(255,255,255,0.05)] py-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <PayzapLogo size={28} />
            <PayzapWordmark className="text-sm" />
